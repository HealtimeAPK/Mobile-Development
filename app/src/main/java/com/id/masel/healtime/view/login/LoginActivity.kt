...
import com.id.masel.healtime.databinding.ActivityLoginBinding
...
import com.id.masel.healtime.view.register.RegisterActivity
...
class LoginActivity : AppCompatActivity(), ViewStateCallback<LoginResponse> {
    ...
    override fun onError(error: String?) {
        progressDialog.hide()
        Log.e(TAG, "onFailed login: $error")
